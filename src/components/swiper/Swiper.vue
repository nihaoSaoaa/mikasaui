  ...
  methods: {
    ...
    handleDom() {
      ...
      if (this.slideCount > 1) {
        const cloneFirst = slideVNODE[0].cloneNode(true);
        const cloneLast = slideVNODE[this.slideCount - 1].cloneNode(true);
        swiperEl.insertBefore(cloneLast, slideVNODE[0]);
